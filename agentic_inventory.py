...
# DEFINE LOGO SVG (Neural Ascent Design for Watermark)
logo_svg = """
...
# --- 5. TOP HUD ---
st.markdown(f"<div class='ticker-wrap'><div class='ticker-text'>[DHWANI] {st.session_state.user.upper()} ACTIVE // [LOGISTICS] Hover Map for Precision Addresses // [SENSING] Predicted demand surge detected // [SYSTEM] Vault Encrypted.</div></div>", unsafe_allow_html=True)
...
if st.session_state.page == "Dashboard":
    ...
    st.markdown("<div class='insight-box'><b>💡 Directive:</b> Command Center stable. All 8 nodes functional. Choose a node from the sidebar to begin analysis.</div>", unsafe_allow_html=True)

# NYASA (MERGED BULK SYNC + MANUAL + PO)
...
# SANCHARA (MAP + ADDRESS + FLOOR OPS)
