...
# --- 2. DATABASE ---
DB_FILE = 'aroha_ultimate_v112.db'
...
# --- 5. SIDEBAR (ALWAYS VISIBLE AFTER LOGIN) ---
with st.sidebar:
...
# --- 6. PAGE LOGIC (THIS IS THE DASHBOARD) ---
